...
export interface EntradaZip {
  ...
  ruta: string;
  /**
   * Texto, o bytes crudos.
   *
   * Acepta `Uint8Array` porque el ZIP dejo de tener solo XML adentro: la
   * carpeta de fotos que se le entrega al cliente son JPEG. Pasarlos por
   * `TextEncoder` los rompe en silencio —cada byte fuera de ASCII se convierte
   * en el reemplazo UTF-8— y el archivo sale del tamano correcto pero ilegible.
   */
