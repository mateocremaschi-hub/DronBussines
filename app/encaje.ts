...
export interface Caja {
  ...
  rotRad: number;
  /**
   * El modulo entero, para poder DIBUJARLO.
   *
   * No se usa para medir —medir toca solo la parte de adentro, sin el marco—
   * pero viaja con la caja porque se calcula en el mismo lugar y con la misma
   * cuenta. Tenerlo aparte era como el recuadro terminaba dibujado en una
   * escala y medido en otra.
   */
  largoModulo?: number;
